  ...
  return (
    <div className="max-w-3xl animate-rise">
      ...
      <ul className="mt-5 flex flex-col gap-2">
        {rows.map(b => (
          <li key={b.id} className={cn('bg-base-panel p-4', !b.is_active && 'opacity-50')}>
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div className="min-w-0 flex-1">
                ...
                <input
                  ...
                  className="mt-1 w-full bg-transparent text-sm text-mute outline-none focus:text-chalk"
                />
              </div>
            ...
            <div className="mt-3 flex items-center gap-3">
              ...
              <button onClick={() => remove(b)} className="ml-auto text-mute hover:text-out" aria-label="Remove">
                <Trash2 size={16} />
              </button>
            </div>
          </li>
