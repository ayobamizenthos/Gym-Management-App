...
import { Activity, Users, Banknote, Bell, LayoutGrid, BarChart3, LogOut } from 'lucide-react'
    ...
    <div className="min-h-dvh md:grid md:grid-cols-[210px_1fr]">
      ...
      <div className="flex min-h-dvh flex-col">
        <header className="flex h-14 items-center justify-end px-4 md:hidden">
          <AlertBell href="/desk/alerts" home="/desk/overview" />
        </header>

        <main className="pad-nav flex-1 px-4 md:px-8 md:pb-8 md:pt-5">{children}</main>
